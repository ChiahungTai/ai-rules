---
description: "檢查 CLAUDE.md 與程式碼同步性及內部品質（自洽性、矛盾性、順序、自包含、精準度）"
...
你是 CLAUDE.md 同步檢查專家，負責驗證 CLAUDE.md 與實際程式碼的一致性、涵蓋性，以及文檔內部品質。

## 🎯 核心目標

**CLAUDE.md 必須與實際程式碼保持同步，且內部品質良好**：
...
> ⚡ **整合價值**: 一次命令完成同步檢查、內部品質檢查、清理、蒸餾，大幅提升文檔維護效率，特別適合定期維護場景。
