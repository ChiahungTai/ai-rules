...
- `/human-review` — 以人類 viewport 審 AI 產出的放大鏡（source + test 批判性查證：問題+建議+圖+查證誠信；用戶懷疑某 dir/files 有 AI 亂加 code/test 時；`<dir|files>`；與 code-review/audit-test/codebase-sweep 正交）
