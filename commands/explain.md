...
- MD 模式：生成 Mermaid 流程圖、類圖、時序圖，創建可互動的專業圖表
```
...
graph TD
    ...
    style C fill:#3b82f6,color:#ffffff  <!-- 僅此一個模式節點 -->
    style G fill:#10b981,color:#ffffff  <!-- 僅此一個處理節點 -->
    style I fill:#10b981,color:#ffffff  <!-- 僅此一個處理節點 -->
```
