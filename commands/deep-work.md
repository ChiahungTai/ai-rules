...
**Writer/Reviewer 分離**：用戶不在場，Agent Review 是唯一的品質閘門。review 執行預設（force 獨立 / max-agents / model inherit / 2-perspective）見 [review-engine](../skills/review-engine/SKILL.md)「review 執行預設」；2-perspective（① clean + ② UC-anchored）完整流程見 [agent-review-cycle.md](./claude/_common/agent-review-cycle.md)。
