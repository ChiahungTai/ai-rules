...
- [architecture-thinking](../skills/architecture-thinking/SKILL.md) + [architecture-viewport](../skills/architecture-viewport/SKILL.md) — 架構視角 + 結構機械（F3 用）
...
- **分層依賴**（承接 execution-plan ①）：domain←use case←adapter←infra 依賴向內？有循環？— 視角見 [architecture-thinking](../skills/architecture-thinking/SKILL.md)，結構資料見 [architecture-viewport](../skills/architecture-viewport/SKILL.md)
