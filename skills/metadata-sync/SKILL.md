...
- build 階段 5c(CLAUDE.md / arch **內容**同步):反映程式碼變更到文檔描述(導航-A 種子、模組職責),屬 [instruction-writing](../../rules/instruction-writing.md) 職責,**非**狀態結算;與本 skill 結算在同一段 5 協調(5a 結算寫 ✅ 行、5c 同步描述)。
