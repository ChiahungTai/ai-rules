...
執行 [daily-maintain skill](../maintain/SKILL.md) 的互動版本。
...
1. **Phase 1**: 結構圖新鮮度（opt-in repo 跑 `code-reality build`、無 index 的 repo skip——見 [maintain](../maintain/SKILL.md) Phase 1）→ **展示結果**
