...
>
> **與 /human-review 的區隔**:`/human-review`(source 側 audit-test,定位「放大鏡」)與本命令正交 — sweep 盤點既有穩固度 / human-review 質疑既有 code 是否該存在（典型：懷疑 AI 亂加）(詳見 [human-review](../human-review/SKILL.md))。「人類產出優先」教訓為兩命令共同設計依據。
>
