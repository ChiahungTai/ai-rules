...
## 使用方式
```bash
/design-plan "設計任務描述" --output "design-[專案名稱].md"
```

**執行後生成**: `ai-analysis/plans/design-[專案名稱].md` - 完整的SD結構化設計文檔

**🚨 強制輸出**: 自動建立 `ai-analysis/plans/` 目錄並強制寫入文檔
